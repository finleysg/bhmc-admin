...
class Course(models.Model):
    ...
    gg_id = models.CharField(
        verbose_name="Golf Genius id: course_id", max_length=22, blank=True, null=True
    )
...
class Tee(models.Model):
    ...
    gg_id = models.CharField(
        verbose_name="Golf Genius id: tee_id", max_length=22, blank=True, null=True
    )
    color = models.CharField(max_length=7, blank=True, null=True)

    class Meta:
        constraints = [UniqueConstraint(fields=["course", "name"], name="unique_course_tee")]
